...
{
    public partial class ChiTietDAQH_PK : Form
    {
        ...
        private void ChiTietDAQH_PK_Load(object sender, EventArgs e)
        {
        ...
        public void Show(IFeatureCursor pCu)
        {
            ...
            dt.Columns.Add("TenPhanKhu", typeof(String));
            ...
            while (pFeature != null)
            {
                ...
                if (pFeature.get_Value(pFeature.Fields.FindField("TenPhanKhu")) != DBNull.Value)
                {
                    dr[1] = pFeature.get_Value(pFeature.Fields.FindField("TenPhanKhu")).ToString();
                }
            ...
            if (int.TryParse(GridView1.GetRowCellValue(0, "OBJECTID").ToString(), out ID1) == true)
            {
                ...
                sql1 = "[PRC_QUERY_TABLE_QuyHoachPK_BY_ID] " + ID1 + "";
                showgridControl2(sql1);
                string Caption = GridView1.GetRowCellValue(0, "TenPhanKhu").ToString();
                cardView1.CardCaptionFormat = Caption;
            }
        }
