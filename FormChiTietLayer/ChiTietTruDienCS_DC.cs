...
{
    public partial class ChiTietTruDienCS_DC : Form
    {
        ...
        private void ChiTietTruDienCS_DC_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (KTMoLop == 0)
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        {
                            if (QLHTDT.FormChinh.KienTruc.axMapControl1.get_Layer(i).Name == "Trụ điện chiếu sáng chính")
                            {
                                KTMoLop = KTMoLop + 1;
