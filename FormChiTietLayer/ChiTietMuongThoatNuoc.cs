...
{
    public partial class ChiTietMuongThoatNuoc : Form
    {
        ...
        private void ChiTietMuongThoatNuoc_Load(object sender, EventArgs e)
        {
        ...
        private void DoRowDoubleClick(GridView view, System.Drawing.Point pt)
        {
            ...
            try
            {
                ...
                if (KTMoLop == 0)
                {
                    DialogResult dialogResult = MessageBox.Show("Chưa mở lớp dữ liệu không gian Mương thoát nước \n" + "Có muốn mở lớp dữ liệu này hay không ?", "Thông báo", MessageBoxButtons.YesNo);
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn muốn xóa Mương thoát nước được chọn " + " không?", "Xóa dữ liệu", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    KienTruc.XoaDoiTuong("Mương thoát nước", ID1);
        ...
        public void Show(IFeatureCursor pCu)
        {
            ...
            dt.Columns.Add("TENMUONG", typeof(String));
            dt.Columns.Add("MaMuong", typeof(String));
            ...
            while (pFeature != null)
            {
                ...
                if (pFeature.get_Value(pFeature.Fields.FindField("TENMUONG")) != DBNull.Value)
                {
                    dr[1] = pFeature.get_Value(pFeature.Fields.FindField("TENMUONG")).ToString();
                }
                //if (pFeature.get_Value(pFeature.Fields.FindField("MaMuong")) != DBNull.Value)
                //{
                //    dr[2] = pFeature.get_Value(pFeature.Fields.FindField("MaMuong")).ToString();
                //}
            ...
            if (int.TryParse(GridView1.GetRowCellValue(0, "OBJECTID").ToString(), out ID1) == true)
            {
                ...
                sql1 = "[PRC_QUERYMuongThoatNuoc_BY_ID] " + ID1 + "";
                showgridControl2(sql1);
                string Caption = GridView1.GetRowCellValue(0, "TENMUONG").ToString();
                cardView1.CardCaptionFormat = Caption;
            }
        }
