...
namespace QLHTDT
{
    ...
    public class CreateNewDocument : BaseCommand
    {
        ...
        public CreateNewDocument()
        {
            ...
            base.m_caption = "Mở trang mới";
            base.m_message = "Tạo bản đồ mới";
            base.m_toolTip = "Tạo bản đồ mới";
        ...
        public override void OnClick()
        {
            ...
            {
                result = MessageBox.Show("Có lưu chỉnh sửa đối tượng hay không?", "Lưu chỉnh sửa", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
            ...
            DialogResult res = MessageBox.Show("Có lưu chỉnh sửa bản đồ hay không?", "Thông báo", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
            ...
            {
                //IMap aas = QLHTDT.FormChinh.QuanTriHeThong.axMapControl1.ActiveView.FocusMap;
                //IMapDocument pmapdoc = aas as MapDocument;
            ...
            mapControl.Map = map;
            //TreeList a = QuanTriHeThong.treelist;
            //QuanTriHeThong.treelist.Nodes[1].Checked = false;
            //QuanTriHeThong.treeList1.RefreshDataSource();
            KienTruc.ActiveForm.Refresh();
