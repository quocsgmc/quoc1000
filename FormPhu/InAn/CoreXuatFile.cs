...
namespace QLHTDT.FormPhu.InAn
{
    class CoreXuatFile
    {
        ...
        public static void ExportActiveViewParameterized(long iOutputResolution, long lResampleRatio, string ExportType, string sOutputDir, Boolean bClipToGraphicsExtent)
        {
            ...
            IActiveView docActiveView = QuanTriHeThong.axPageLayoutControl1.ActiveView;
            IExport docExport;
