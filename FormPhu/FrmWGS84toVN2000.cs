...
{
    public partial class FrmWGS84toVN2000 : Form
    {
        System.Windows.Forms.OpenFileDialog openFileDialog = new System.Windows.Forms.OpenFileDialog();
        System.Windows.Forms.SaveFileDialog SaveFileDialog = new System.Windows.Forms.SaveFileDialog();
        public FrmWGS84toVN2000()
        {
            InitializeComponent();
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (System.IO.FileStream fs = File.Create(path))
                {
                    ...
                    "InShapeCoppy = r\"" + InShapeCoppy + "\"" + Environment.NewLine +
                    "WGS84 = r\"" + InShapeCoppy + "\"" + Environment.NewLine +
                    "arcpy.CopyFeatures_management(InShape, InShapeCoppy, \"\", \"0\", \"0\", \"0\")" + Environment.NewLine +
                    "arcpy.DefineProjection_management(InShapeCoppy, \"GEOGCS['GCS_WGS_1984', DATUM['D_WGS_1984', SPHEROID['WGS_1984', 6378137.0, 298.257223563]], PRIMEM['Greenwich', 0.0], UNIT['Degree', 0.0174532925199433]]\")" + Environment.NewLine +
                    "arcpy.Project_management(WGS84, SanPham, \"PROJCS['VN_2000_UTM_DaNang_Mui3',GEOGCS['GCS_VN_2000',DATUM['D_Vietnam_2000',SPHEROID['WGS_1984',6378137.0,298.257223563]],PRIMEM['Greenwich',0.0],UNIT['Degree',0.0174532925199433]],PROJECTION['Transverse_Mercator'],PARAMETER['False_Easting',500000.0],PARAMETER['False_Northing',0.0],PARAMETER['Central_Meridian',"+comboBox1.Text+"],PARAMETER['Scale_Factor',"+MuiChieu+"],PARAMETER['Latitude_Of_Origin',0.0],UNIT['Meter',1.0]]\", \"WGS84ToVN2000\", \"\")";
