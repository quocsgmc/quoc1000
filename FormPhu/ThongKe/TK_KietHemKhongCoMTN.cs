...
{
    public partial class TK_KietHemKhongCoMTN : Form
    {
        ...
        {
            string sql = "[PRC_TK_KietHem_KhongCoMTN] " + MaHuyen + ", " + MaXa + "";
        ...
        private void TK_KietHemKhongCoMTN_Load(object sender, EventArgs e)
        {
