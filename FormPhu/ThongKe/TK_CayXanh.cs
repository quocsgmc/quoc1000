...
{
    public partial class TK_CayXanh : Form
    {
        int AddQuan = 0;
        DataTable tb;
        DataTable tbcheck;
        ...
        {
            string sql = "[PRC_STATISTICAL_TREE] "+MaHuyen+", "+MaXa+"";
        ...
        private void TK_CayXanh_Load(object sender, EventArgs e)
        {
        ...
        {
            QLHTDT.FormPhu.ThongKe.TK_GTChinh_CoCayXanh frm = new QLHTDT.FormPhu.ThongKe.TK_GTChinh_CoCayXanh();
            frm.Show();
        }

        private void button3_Click(object sender, EventArgs e)
        {
            QLHTDT.FormPhu.ThongKe.TK_GTChinh_KhongCoCayXanh frm = new QLHTDT.FormPhu.ThongKe.TK_GTChinh_KhongCoCayXanh();
            frm.Show();
        }
    }
}
