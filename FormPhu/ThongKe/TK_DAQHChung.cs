...
{
    public partial class TK_DAQHChung : Form
    {
        int AddQuan = 0;
        DataTable tb;
        DataTable tbcheck;
        ...
        private void TK_DAQHChung_Load(object sender, EventArgs e)
        {
            DataSet ds2 = new DataSet();
            SqlDataAdapter adp2 = new SqlDataAdapter("Select TenloaiPolygon from LoaiPolygonQH", QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
            adp2.Fill(ds2);
            cboQuan.Items.Add("");
            ...
            string sql = "[TK_DAQH_ChungChiTiet] null,null,null";
