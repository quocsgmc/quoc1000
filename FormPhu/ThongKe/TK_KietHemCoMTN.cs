...
{
    public partial class TK_KietHemCoMTN : Form
    {
        ...
        {
            string sql = "[PRC_TK_KietHem_CoMTN] " + MaHuyen + ", " + MaXa + "";
        ...
        private void TK_KietHemCoMTN_Load(object sender, EventArgs e)
        {
