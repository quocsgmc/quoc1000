...
{
    public partial class TK_TuyenDienCS_CoTru : Form
    {
        ...
        {
            string sql = "[PRC_TK_TuyenDienCS_CoTruCS] " + MaHuyen + ", " + MaXa + "";
        ...
        private void TK_TuyenDienCS_CoTru_Load(object sender, EventArgs e)
        {
