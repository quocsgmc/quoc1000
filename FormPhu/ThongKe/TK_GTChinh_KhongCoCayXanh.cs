...
{
    public partial class TK_GTChinh_KhongCoCayXanh : Form
    {
        ...
        string ThongKe;
        string Phuong;
        public TK_GTChinh_KhongCoCayXanh()
        {
            InitializeComponent();
        ...
        private void TK_GTChinh_KhongCoCayXanh_Load(object sender, EventArgs e)
        {
        ...
        {
            string sql = "[PRC_TK_DuongChinh_KhongCoCay] " + MaHuyen + ", " + MaXa + "";
