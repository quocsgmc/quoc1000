...
{
    public partial class TK_TruDienCS : Form
    {
        DataTable tb;
        DataTable tbcheck;
        ...
        {
            string sql = "[PRC_STATISTICAL_ELECTRIC_POST] " + MaHuyen + ", " + MaXa + "";
        ...
        private void TK_TruDienCS_Load(object sender, EventArgs e)
        {
        ...
        {
            QLHTDT.FormPhu.ThongKe.TK_TuyenDienCS_CoTru frm = new QLHTDT.FormPhu.ThongKe.TK_TuyenDienCS_CoTru();
            frm.Show();
        }

        private void button3_Click(object sender, EventArgs e)
        {
            QLHTDT.FormPhu.ThongKe.TK_TuyenDienCS_KhongCoTru frm = new QLHTDT.FormPhu.ThongKe.TK_TuyenDienCS_KhongCoTru();
            frm.Show();
        }
    }
}
