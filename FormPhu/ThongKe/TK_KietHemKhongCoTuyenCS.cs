...
{
    public partial class TK_KietHemKhongCoTuyenCS : Form
    {
        ...
        string ThongKe;
        string Phuong = "";
        public TK_KietHemKhongCoTuyenCS()
        {
            InitializeComponent();
        ...
        {
            string sql = "[PRC_TK_KietHem_KhongCoTuyenDien] " + MaHuyen + ", " + MaXa + "";
        ...
        private void TK_KietHemKhongCoTuyenCS_Load(object sender, EventArgs e)
        {
