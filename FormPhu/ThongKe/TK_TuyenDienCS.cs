...
{
    public partial class TK_TuyenDienCS : Form
    {
        DataTable tb;
        DataTable tbcheck;
        SqlDataAdapter dataAdapter1;
        SqlCommandBuilder cmbl;
        public TK_TuyenDienCS()
        {
            InitializeComponent();
        }
        void showgridControl1(string MaHuyen, string MaXa)
        {
            string sql = "[PRC_STATISTICAL_ELECTRIC_LINE] " + MaHuyen + ", " + MaXa + "";
        ...
        private void TK_TuyenDienCS_Load(object sender, EventArgs e)
        {
        ...
        {
            QLHTDT.FormPhu.ThongKe.TK_KietHemCoTuyenCS frm = new QLHTDT.FormPhu.ThongKe.TK_KietHemCoTuyenCS();
            frm.Show();
        }

        private void button3_Click(object sender, EventArgs e)
        {
            QLHTDT.FormPhu.ThongKe.TK_KietHemKhongCoTuyenCS frm = new QLHTDT.FormPhu.ThongKe.TK_KietHemKhongCoTuyenCS();
            frm.Show();
        }
    }
}
