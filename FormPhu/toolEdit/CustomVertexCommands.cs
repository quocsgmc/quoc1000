...
namespace VertexCommands_CS
{
    ...
    public sealed class CustomVertexCommands : BaseTool, ICommandSubType
    {
        ...
        public CustomVertexCommands()
        {
            ...
            try
            {
                m_InsertVertexCursor = new System.Windows.Forms.Cursor(GetType(), "InsertVertexCursor.cur");
                m_DeleteVertexCursor = new System.Windows.Forms.Cursor(GetType(), "DeleteVertexCursor.cur");
            }
            catch (Exception ex)
            {
            ...
            get
            {
                ...
                switch (m_lSubType)
                {
                    case 1:
                        ...
                        Cursor = new System.Windows.Forms.Cursor(GetType(), "CustomVertexCommands.cur");
                        iHandle = Cursor.Handle.ToInt32();
                        break;
        ...
        public void SetSubType(int SubType)
        {
            ...
            switch (m_lSubType)
            {
                case 1: //Insert Vertex using the out-of-the-box ControlsEditingSketchInsertPointCommand command
                    ...
                    base.m_caption = "InsertVertex";
                    base.m_message = "InsertVertex";
                    base.m_toolTip = "InsertVertex";
                ...
                case 2: //Delete vertex at clicked location using the out-of-the-box ControlsEditingSketchDeletePointCommand
                    ...
                    base.m_caption = "DeleteVertex_CommandCaption";
                    base.m_message = "DeleteVertex_CommandMessage";
                    base.m_toolTip = "DeleteVertex_CommandToolTip";
