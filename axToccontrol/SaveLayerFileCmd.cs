...
namespace QLHTDT.FormPhu
{
  ...
  public sealed class SaveLayerFileCmd : BaseCommand
  {
    ...
    {
      base.m_category = "Lưu layer"; 
      base.m_caption = "Lưu layer";
      base.m_message = "Save the current layer as a layer file";
      base.m_toolTip = "Lưu layer";
    ...
    public override void OnClick()
    {
      ...
      if (saveFileDialog.FileName != "" && dr == DialogResult.OK)
      {
        ...
        if (DialogResult.Yes == MessageBox.Show("Có muốn mở layer vừa tạo hay không?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
        {
