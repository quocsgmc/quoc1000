...
{
    public partial class ThemMoiToaDo1DiemTuyenMuong : Form
    {
        public static int STT = 0;
        public static double X = 0;
        public static double Y = 0;
        public ThemMoiToaDo1DiemTuyenMuong()
        {
            InitializeComponent();
        ...
        {
            for (int i = 1; i < QuanLyToaDoTuyenMuong.numrow; i++)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else STT = QuanLyToaDoTuyenMuong.numrow;
