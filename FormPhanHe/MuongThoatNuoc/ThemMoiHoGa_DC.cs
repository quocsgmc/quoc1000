...
{
    public partial class ThemMoiHoGa_DC : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ftClassSDE = QLHTDT.FormChinh.KienTruc.FeatureWorkspace.OpenFeatureClass("HOGADC");
                    // tạo mới đối tượng
                    ...
                    KienTruc.ThemMoiDoiTuong("Hố ga chính", objectid);
