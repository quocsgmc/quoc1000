...
{
    public partial class ThemMoiMuongThoatNuoc : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        private void ThemMoiMuongThoatNuoc_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    KienTruc.ThemMoiDoiTuong("Mương thoát nước kiệt hẻm", objectid);
