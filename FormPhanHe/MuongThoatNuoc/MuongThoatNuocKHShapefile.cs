...
{
    public partial class MuongThoatNuocKHShapefile : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        public MuongThoatNuocKHShapefile()
        {
            InitializeComponent();
        ...
        private void MuongThoatNuocKHShapefile_Load(object sender, EventArgs e)
        {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Thêm mới Mương thoát nước kiệt hẻm thành công", "Thông báo");
