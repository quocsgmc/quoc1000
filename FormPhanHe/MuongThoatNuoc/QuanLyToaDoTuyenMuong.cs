...
{
    public partial class QuanLyToaDoTuyenMuong : Form
    {
        ...
        int IDTuyenCapNgam = QLHTDT.FormPhanHe.MuongThoatNuoc.QuanLyMuongThoatNuoc2.QuanLyMuongThoatNuoc2.ID1;
        int IDCHUDAUTU;
        ...
        private void QuanLyToaDoTuyenMuong_Load(object sender, EventArgs e)
        {
        ...
        {
            string sql = "[PRC_ToaDoTuyenMuong_GET_BY_ID] " + IDTuyenCapNgam + "";
            tb = new DataTable();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn muốn lưu các dữ liệu thay đổi không?", "Lưu dữ liệu", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                try
                {
                    string shape = "[PRC_UPDATE_SHAPE_MuongThoatNuoc] " + IDTuyenCapNgam + ", 'LINESTRING (";
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            ThemMoiToaDo1DiemTuyenMuong frm = new ThemMoiToaDo1DiemTuyenMuong();
            frm.ShowDialog();
            if (frm.Visible == false)
            {
                DataRow barackRow = getRow(tb, ThemMoiToaDo1DiemTuyenMuong.X, ThemMoiToaDo1DiemTuyenMuong.Y);
                tb.Rows.InsertAt(barackRow, ThemMoiToaDo1DiemTuyenMuong.STT);
            }
            converttable();
            GridView1.RefreshData();
        }
