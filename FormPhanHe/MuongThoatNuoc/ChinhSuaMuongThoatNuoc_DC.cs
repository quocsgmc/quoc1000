...
{
    public partial class ChinhSuaMuongThoatNuoc_DC : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        int IDChinhSua;
        string IDPhuong;
        public ChinhSuaMuongThoatNuoc_DC(int OBJECTID)
        {
            InitializeComponent();
        ...
        private void ChinhSuaMuongThoatNuoc_DC_Load(object sender, EventArgs e)
        {
            ...
            if (IDChinhSua != 0)
            {
                SqlDataAdapter adp3 = new SqlDataAdapter("[PRC_QUERYMuongThoatNuocDC_BY_ID] " + IDChinhSua + "", QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
                ...
                txtChieuRong.Text = ds3.Tables[0].Rows[0]["CHIEURONG"].ToString();
                txtChieuCao.Text = ds3.Tables[0].Rows[0]["CHIEUCAO"].ToString();
                txtChieuDai.Text = ds3.Tables[0].Rows[0]["CHIEUDAI"].ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    KienTruc.ChinhSuathuoctinhToolQuanLy("Mương thoát nước chính", objectid);
