...
namespace QLHTDT.FormPhanHe.CayXanh.QLCayXanh.NhatKyCSCayXanh
{
    public partial class NhatKyCSCayXanh : Form
    {
        ...
        string sql = "[PRC_QUERYTABLE_NhatKyCSCayBongMa]";

        public NhatKyCSCayXanh()
        {
            InitializeComponent();
        }


        private void NhatKyCSCayXanh_Load(object sender, EventArgs e)
        {
            showgridControl1();
            bool ChinhSua = false;
        }
