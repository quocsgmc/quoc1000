...
namespace QLHTDT.FormPhanHe.CayXanh.QLTrangTri.NhatKyCSTrangTri
{
    public partial class NhatKyCSTrangTri : Form
    {
        ...
        string sql = "[PRC_QUERYTABLE_NhatKyCSCayTrangTri]";

        public NhatKyCSTrangTri()
        {
            InitializeComponent();
        }


        private void NhatKyCSTrangTri_Load(object sender, EventArgs e)
        {
            showgridControl1();
            bool ChinhSua = false;
        }
