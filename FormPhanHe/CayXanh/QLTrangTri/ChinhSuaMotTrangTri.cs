...
{
    public partial class ChinhSuaMotTrangTri : Form
    {
        ...
        int IDChinhSua = QLHTDT.FormPhanHe.CayXanh.QuanLyTrangTri.QuanLyTrangTri.ID1;
        public ChinhSuaMotTrangTri()
        {
            InitializeComponent();
        ...
        private void ChinhSuaMotTrangTri_Load(object sender, EventArgs e)
        {
            ...
            if (IDChinhSua != 0)
            {
                SqlDataAdapter adp6 = new SqlDataAdapter("[PRC_QUERYCayTrangTri_BY_ID] " + IDChinhSua + "", QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
                ...
                txtKinhDo.Text = ds6.Tables[0].Rows[0]["ToaDoY"].ToString();
                txtViDo.Text = ds6.Tables[0].Rows[0]["ToaDoX"].ToString();
            }
        }
            ...
            if (check != false)
            {
                try
                {
                    if (comboHeToaDo.Text == "VN2000")
                    {
                        ...
                        MessageBox.Show("Chỉnh sửa Cây trang trí thành công", "Thông báo");
                ...
                catch
                {
                    ...
                    MessageBox.Show("Chỉnh sửa Cây trang trí thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
        ...
        private void comboHeToaDo_SelectedIndexChanged(object sender, EventArgs e)
        {
