...
namespace QLHTDT.FormPhanHe.CayXanh.TimKiemTaiSan
{
    public partial class TimKiemTaiSan : Form
    {
        ...
        public TimKiemTaiSan()
        {
            InitializeComponent();
            dmap = QLHTDT.FormChinh.KienTruc.axMapControl1.Map;
        }

        private void TimKiemTaiSan_Load(object sender, EventArgs e)
        {
