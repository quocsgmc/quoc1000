...
{
    public partial class UpdateDiaChi : Form
    {
            ...
            //{
                ...
                //{
                    for (iLoi = 0; iLoi < dgvData.RowCount - 1; iLoi++)
                    {
                        ...
                        if (comboBox4.Text != "")
                        { OBJECTID1 = dgvData.Rows[iLoi].Cells[OBJECTID].Value.ToString(); }
                        else { OBJECTID1 = "null"; }

                        //cập nhật thuộc tính đối tượng
                        SqlConnection conn = new SqlConnection(QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
                        conn.Open();
                        string sql1 = "[PRC_UPDATE_DiaChi] " //update Cây xanh
                       + " " + IDCayXanh1
                       + ", " + Name1
                       + "," + Url1
                       + ", " + OBJECTID1 + "";
                    ...
                    MessageBox.Show("Update Địa chỉ thành công", "Thông báo");
