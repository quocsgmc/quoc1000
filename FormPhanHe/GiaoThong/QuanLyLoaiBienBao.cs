...
{
    public partial class QuanLyLoaiBienBao : Form
    {
        ...
        int IDLOAITRAM;
        string sql = "[PRC_QUERY_TABLE_LoaiBienBao]";
        public QuanLyLoaiBienBao()
        {
            InitializeComponent();
        ...
        private void QuanLyLoaiBienBao_Load(object sender, EventArgs e)
        {
        ...
        private void BtExcell_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn muốn xóa dữ liệu được chọn " + " không?", "Xóa dữ liệu", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    string Delelequery = "[PRC_DELETE_LoaiBienBao] " + IDLOAITRAM + "";
        ...
        private void BtTracuu_Click(object sender, EventArgs e)
        {
            ...
            view.ActiveFilter.Add(view.Columns["TENBIEN"],
               new ColumnFilterInfo("[TENBIEN] like '%" + txtTenBien.Text + "%'", ""));
        }
        public void ChinhSua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                QLHTDT.FormPhanHe.GiaoThong.ChinhSua.ChinhSuaLoaiBienBao frm = new QLHTDT.FormPhanHe.GiaoThong.ChinhSua.ChinhSuaLoaiBienBao();
                frm.ShowDialog();
            }
            catch
            {
                MessageBox.Show("Vui lòng chọn Loại biển báo chỉnh sửa.", "Thông báo");
            }
        }
        private void Btloadlailop_Click(object sender, EventArgs e)
        {
            txtTenBien.ResetText();
            comboLoaiBien.ResetText();
            showgridControl1();
        ...
        private void txtIDLoaiTram_TextChanged(object sender, EventArgs e)
        {
            ...
            view.ActiveFilter.Add(view.Columns["ID"],
              new ColumnFilterInfo("[ID] like '%" + txtTenBien.Text + "%'", ""));
        }

        private void button2_Click(object sender, EventArgs e)
        {
            Cursor = Cursors.WaitCursor;
            QLHTDT.FormPhanHe.GiaoThong.ThemMoi.ThemMoiLoaiBienBao frm = new QLHTDT.FormPhanHe.GiaoThong.ThemMoi.ThemMoiLoaiBienBao();
            frm.ShowDialog();
        ...
        private void comboBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            view.ActiveFilter.Add(view.Columns["LOAIBIEN"],
               new ColumnFilterInfo("LOAIBIEN like '%" + txtTenBien.Text + "%'", ""));
        }
