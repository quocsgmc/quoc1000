...
{
    public partial class ChinhSuaViaHe : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        int IDChinhSua = QLHTDT.FormPhanHe.GiaoThong.QuanLyViaHe.QuanLyViaHe.ID1;
        public ChinhSuaViaHe()
        {
            InitializeComponent();
        ...
        private void ChinhSuaViaHe_Load(object sender, EventArgs e)
        {
            ...
            if (IDChinhSua != 0)
            {
                SqlDataAdapter adp3 = new SqlDataAdapter("[PRC_QUERY_TABLE_ViaHe_BY_ID] " + IDChinhSua + "", QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
                DataSet ds3 = new DataSet();
                adp3.Fill(ds3);
                //txtIDTuyen.Text = ds3.Tables[0].Rows[0]["IDTuyen"].ToString();
                textBox1.Text = ds3.Tables[0].Rows[0]["DIENTICH"].ToString();
                textBox2.Text = ds3.Tables[0].Rows[0]["TINHTRANG"].ToString();
                textBox3.Text = ds3.Tables[0].Rows[0]["CHIEURONG"].ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    KienTruc.ChinhSuathuoctinhToolQuanLy("Vỉa hè", objectid);
                    KienTruc.dataAdapterNK.Update(KienTruc.TBNK);

                    MessageBox.Show("Chỉnh sửa Vỉa hè thành công", "Thông báo");
                ...
                catch
                {
                    ...
                    if (feature != null)
                    { feature.Delete(); }
                    MessageBox.Show("Chỉnh sửa Vỉa hè thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
