...
{
    public partial class ChinhSuaCauDuongBo : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        private void ChinhSuaCauDuongBo_Load(object sender, EventArgs e)
        {
            ...
            if (IDChinhSua != 0)
            {
                SqlDataAdapter adp3 = new SqlDataAdapter("[PRC_QUERY_TABLE_Cau_BY_ID] " + IDChinhSua + "", QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
                DataSet ds3 = new DataSet();
                adp3.Fill(ds3);
                textbox01.Text = ds3.Tables[0].Rows[0]["TenCau"].ToString();
                textbox02.Text = ds3.Tables[0].Rows[0]["SoLan"].ToString();
                textbox03.Text = ds3.Tables[0].Rows[0]["TaiTrongTK"].ToString();
                textbox04.Text = ds3.Tables[0].Rows[0]["TaiTrongKT"].ToString();
                textbox05.Text = ds3.Tables[0].Rows[0]["MatCat"].ToString();
                textbox06.Text = ds3.Tables[0].Rows[0]["NAMKT"].ToString();
                textbox07.Text = ds3.Tables[0].Rows[0]["SoDoNhip"].ToString();
                textbox08.Text = ds3.Tables[0].Rows[0]["SoLuongNhip"].ToString();
                textbox09.Text = ds3.Tables[0].Rows[0]["KetCauNhip"].ToString();
                textbox10.Text = ds3.Tables[0].Rows[0]["KetCauMoTru"].ToString();
                textbox11.Text = ds3.Tables[0].Rows[0]["KhoThongThuyenNgang"].ToString();
                textbox12.Text = ds3.Tables[0].Rows[0]["LyTrinh"].ToString();
                textbox13.Text = ds3.Tables[0].Rows[0]["TongChieuDai"].ToString();
                textbox14.Text = ds3.Tables[0].Rows[0]["GhiChu"].ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    KienTruc.ChinhSuathuoctinhToolQuanLy("Cầu", objectid);
                    KienTruc.dataAdapterNK.Update(KienTruc.TBNK);

                    MessageBox.Show("Chỉnh sửa Cầu thành công", "Thông báo");
                ...
                catch
                {
                    ...
                    MessageBox.Show("Chỉnh sửa Cầu thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
