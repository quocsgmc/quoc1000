...
namespace QLHTDT.FormPhanHe.GiaoThong.QuanLyKietHem2
{
    public partial class QuanLyKietHem2 : Form
    {
        ...
        {
            Cursor = Cursors.WaitCursor;
            QLHTDT.FormPhanHe.GiaoThong.ThemMoi.ThemMoiKietHem frm = new QLHTDT.FormPhanHe.GiaoThong.ThemMoi.ThemMoiKietHem();
            frm.TopMost = true;
            frm.Show();
            Cursor = Cursors.Default;
        }
        ...
        {
            Cursor = Cursors.WaitCursor;
            QLHTDT.FormPhanHe.GiaoThong.ThemMoi.KietHemShapefile frm = new QLHTDT.FormPhanHe.GiaoThong.ThemMoi.KietHemShapefile();
            frm.TopMost = true;
            frm.Show();
            Cursor = Cursors.Default;
        }
        ...
        {
            Cursor = Cursors.WaitCursor;
            QLHTDT.FormPhu.ThongKe.TK_KietHem frm = new QLHTDT.FormPhu.ThongKe.TK_KietHem();
            frm.Show();
            Cursor = Cursors.Default;
        }
        ...
        private void txtTenDuong_TextChanged(object sender, EventArgs e)
        {
            ColumnView view = GridView1;
            view.ActiveFilter.Add(view.Columns["TENKIETHEM"],
              new ColumnFilterInfo("[TENKIETHEM] like '%" + txtLoaiDuong.Text + "%'", ""));
        }
    }
}
