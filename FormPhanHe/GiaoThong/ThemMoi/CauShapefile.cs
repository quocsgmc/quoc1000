...
{
    public partial class CauShapefile : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        private void CauShapefile_Load(object sender, EventArgs e)
        {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < featureClass.FeatureCount(null); i++)
            {
                ...
                int TT1 = ftClassSDE.FindField("TenCau");
                ...
                int TT2 = ftClassSDE.FindField("SoLan");
                ...
                int TT3 = ftClassSDE.FindField("TaiTrongTK");
                ...
                int TT4 = ftClassSDE.FindField("TaiTrongKT");
                ...
                int TT5 = ftClassSDE.FindField("MatCat");
                ...
                int TT6 = ftClassSDE.FindField("NAMKT");
                ...
                int TT7 = ftClassSDE.FindField("TongChieuDai");
                ...
                int TT8 = ftClassSDE.FindField("SoDoNhip");
                ...
                int TT9 = ftClassSDE.FindField("SoLuongNhip");
                ...
                int TT10 = ftClassSDE.FindField("KetCauNhip");
                ...
                int TT11 = ftClassSDE.FindField("KetCauMoTru");
                ...
                int TT12 = ftClassSDE.FindField("KhoThongThuyenNgang");
                if (((TreeListNode)treeList2.Nodes[11]).GetDisplayText(treeList2.Columns[1]) != "")
                {
                    feature.set_Value(TT12, ifeshp.get_Value(ifeshp.Fields.FindField(((TreeListNode)treeList2.Nodes[11]).GetDisplayText(treeList2.Columns[1]))).ToString());
                }
                else { feature.set_Value(TT12, null); }

                int TT13 = ftClassSDE.FindField("GhiChu");
                if (((TreeListNode)treeList2.Nodes[12]).GetDisplayText(treeList2.Columns[1]) != "")
                {
                    feature.set_Value(TT13, ifeshp.get_Value(ifeshp.Fields.FindField(((TreeListNode)treeList2.Nodes[12]).GetDisplayText(treeList2.Columns[1]))).ToString());
                }
                else { feature.set_Value(TT13, null); }

                int TT14 = ftClassSDE.FindField("MaXa");
                if (((TreeListNode)treeList2.Nodes[13]).GetDisplayText(treeList2.Columns[1]) != "")
                {
                    feature.set_Value(TT14, ifeshp.get_Value(ifeshp.Fields.FindField(((TreeListNode)treeList2.Nodes[13]).GetDisplayText(treeList2.Columns[1]))).ToString());
                }
                else { feature.set_Value(TT14, null); }
