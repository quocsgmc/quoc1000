...
{
    public partial class GiaoThongShapefile : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        private void GiaoThongShapefile_Load(object sender, EventArgs e)
        {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < featureClass.FeatureCount(null); i++)
            {
                ...
                int TT1 = ftClassSDE.FindField("TenDuong");
                ...
                int TT2 = ftClassSDE.FindField("LoaiDuong");
                ...
                int TT3 = ftClassSDE.FindField("ChieuDai");
                ...
                int TT4 = ftClassSDE.FindField("MatCat");
                ...
                int TT5 = ftClassSDE.FindField("DIEMDAU");
                ...
                int TT6 = ftClassSDE.FindField("DIEMCUOI");
                ...
                int TT7 = ftClassSDE.FindField("MaXa");
                ...
                int TT8 = ftClassSDE.FindField("GhiChu");
            ...
            MessageBox.Show("Thêm mới Giao thông chính thành công", "Thông báo");
