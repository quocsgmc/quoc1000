...
{
    public partial class ThemMoiKietHem : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        int IDChinhSua = QLHTDT.FormPhanHe.GiaoThong.QuanLyKietHem2.QuanLyKietHem2.ID1;
        public ThemMoiKietHem()
        {
            InitializeComponent();
        ...
        private void ThemMoiKietHem_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    KienTruc.ThemMoiDoiTuong("Kiệt hẻm", objectid);
                ...
                catch
                {
                    ...
                    MessageBox.Show("Thêm mới Kiệt hẻm thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
