...
{
    public partial class ViaHeShapefile : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        private void ViaHeShapefile_Load(object sender, EventArgs e)
        {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < featureClass.FeatureCount(null); i++)
            {
                ...
                int MaKhuQH = ftClassSDE.FindField("DIENTICH");
                ...
                int TenDuAn = ftClassSDE.FindField("CHIEURONG");
                ...
                int QDPL = ftClassSDE.FindField("TINHTRANG");
                ...
                int ChuDauTU = ftClassSDE.FindField("IDDUONG");
                ...
                int NamQDPL = ftClassSDE.FindField("GHICHU");
