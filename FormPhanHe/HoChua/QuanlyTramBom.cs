...
{
    public partial class QuanlyTramBom : Form
    {
        ...
        private void QuanlyTramBom_Load(object sender, EventArgs e)
        {
        ...
        public void ChinhSua_Click(object sender, EventArgs e)
        {
            ...
            {
                int.TryParse(GridView1.GetRowCellValue(GridView1.FocusedRowHandle, "IDTramBom").ToString(), out ID1);
                QLHTDT.FormPhanHe.HoChua.ChinhSua.ChinhSuaTramBom frm = new QLHTDT.FormPhanHe.HoChua.ChinhSua.ChinhSuaTramBom();
                frm.Show();
            }
        ...
        private void GridView1_Click(object sender, EventArgs e)
        {
            if (int.Parse(GridView1.FocusedRowHandle.ToString()) >= 0)
            {
                ...
                {
                    int.TryParse(GridView1.GetRowCellValue(GridView1.FocusedRowHandle, "IDTramBom").ToString(), out ID1);
                    sql1 = "[PRC_QUERY_TABLE_TramBom_BY_ID] " + ID1 + "";
                    showgridControl2(sql1);
                }
                catch
                {
