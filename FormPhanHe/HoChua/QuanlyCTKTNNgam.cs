...
{
    public partial class QuanlyCTKTNNgam : Form
    {
        ...
        string sql1 = "[PRC_QUERY_TABLE_CTKTNNuocNgam_BY_ID] " + ID1 + "";
        public QuanlyCTKTNNgam()
        {
            InitializeComponent();
            dmap = QLHTDT.FormChinh.KienTruc.axMapControl1.Map;
            GridView1.CustomDrawRowIndicator += new DevExpress.XtraGrid.Views.Grid.RowIndicatorCustomDrawEventHandler(gridView1_CustomDrawRowIndicator);
        }
        public QuanlyCTKTNNgam(int ID)
        {
            InitializeComponent();
            dmap = QLHTDT.FormChinh.KienTruc.axMapControl1.Map;
            GridView1.CustomDrawRowIndicator += new DevExpress.XtraGrid.Views.Grid.RowIndicatorCustomDrawEventHandler(gridView1_CustomDrawRowIndicator);
            string sql = "[PRC_QUERY_TABLE_CTKTNNuocNgam]"+ID+"";
            showgridControl1(sql);
        }
        ...
        private void QuanlyCTKTNNgam_Load(object sender, EventArgs e)
        {
        ...
        void showgridControl1(string sql)
        {
            tb = new DataTable();
        ...
        public void ChinhSua_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(GridView1.FocusedRowHandle.ToString()) >= 0)
            {
                ...
                QLHTDT.FormPhanHe.HoChua.ChinhSua.ChinhSuaCTKTNNgam frm = new QLHTDT.FormPhanHe.HoChua.ChinhSua.ChinhSuaCTKTNNgam();
                frm.Show();
            }
        ...
        private void GridView1_Click(object sender, EventArgs e)
        {
            if (int.Parse(GridView1.FocusedRowHandle.ToString()) >= 0)
            {
                try
                {
                    int.TryParse(GridView1.GetRowCellValue(GridView1.FocusedRowHandle, "IDCongTrinh").ToString(), out ID1);
                    sql1 = "[PRC_QUERY_TABLE_CTKTNNuocNgam_BY_ID] " + ID1 + "";
                    showgridControl2(sql1);
                }
                catch
                {
