...
{
    public partial class QuanlyCapPhepKTNNgam : Form
    {
        ...
        private void QuanlyCapPhepKTNNgam_Load(object sender, EventArgs e)
        {
        ...
        private void BtTracuu_Click(object sender, EventArgs e)
        {
            ...
            view.ActiveFilter.Add(view.Columns["TenCongTrinh"],
               new ColumnFilterInfo("[TenCongTrinh] like '%" + comboChuDauTu.Text + "%'", ""));
        }
        public void ChinhSua_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(GridView1.FocusedRowHandle.ToString()) >= 0)
            {
                ...
                QLHTDT.FormPhanHe.HoChua.ChinhSua.ChinhSuaCapPhepKTNNgam frm = new QLHTDT.FormPhanHe.HoChua.ChinhSua.ChinhSuaCapPhepKTNNgam();
                frm.Show();
            }
        ...
        {
            Cursor = Cursors.WaitCursor;
            QLHTDT.FormPhanHe.HoChua.ThemMoi.ThemMoiCapPhepKTNNgam frm = new QLHTDT.FormPhanHe.HoChua.ThemMoi.ThemMoiCapPhepKTNNgam();
            frm.ShowDialog(this);
            if (LoadLaiForm == 1)
            {
                showgridControl1();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            Cursor = Cursors.WaitCursor;
            int.TryParse(GridView1.GetRowCellValue(GridView1.FocusedRowHandle, "ID").ToString(), out ID1);
            QLHTDT.FormPhanHe.HoChua.QuanlyCTKTNNgam.QuanlyCTKTNNgam frm = new QLHTDT.FormPhanHe.HoChua.QuanlyCTKTNNgam.QuanlyCTKTNNgam(ID1);
            frm.ShowDialog(this);
            Cursor = Cursors.Default;
        }
        ...
        private void GridView1_Click(object sender, EventArgs e)
        {
            if (int.Parse(GridView1.FocusedRowHandle.ToString()) >= 0)
            {
                ...
                {
                    int.TryParse(GridView1.GetRowCellValue(GridView1.FocusedRowHandle, "ID").ToString(), out ID1);
                    sql1 = "[PRC_QUERY_TABLE_CapPhepKTNNgam_BY_ID] " + ID1 + "";
                    showgridControl2(sql1);
                }
                catch
                {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn muốn xóa Cấp phép được chọn " + " không?", "Xóa dữ liệu", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    conn.Open();
                    string Delelequery = "[PRC_DELETE_CapPhepKTNNgam] " + ID1 + "";
