...
{
    public partial class ThemMoiCapPhepKTNNgam : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                        ...
                        conn.Open();
                        string sql1 = "[PRC_INSERT_CapPhepKTNNgam] "
                           + " '" + textBox1.Text
                           + "', '" + dateCP
                           + "', N'" + textbox01.Text
                           + "', N'" + textbox04.Text
                        ...
                        MessageBox.Show("Thêm mới Cấp phép khai thác nước ngầm thành công", "Thông báo");
                ...
                catch
                {
                    ...
                    MessageBox.Show("Thêm mới Cấp phép khai thác nước ngầm thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
