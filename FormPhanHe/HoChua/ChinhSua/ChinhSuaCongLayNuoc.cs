...
{
    public partial class ChinhSuaCongLayNuoc : Form
    {
        ...
        int IDChinhSua = QLHTDT.FormPhanHe.HoChua.QuanlyCongLayNuoc.QuanlyCongLayNuoc.ID1;
        public ChinhSuaCongLayNuoc()
        {
            InitializeComponent();
            if (QLHTDT.FormChinh.KienTruc.FeatureWorkspace != null)
            { featureWorkspaceSDE = QLHTDT.FormChinh.KienTruc.FeatureWorkspace; }
        }
        private void ChinhSuaCongLayNuoc_Load(object sender, EventArgs e)
        {
            ...
            if (IDChinhSua != 0)
            {
                ...
                textbox02.Text = ds3.Tables[0].Rows[0]["KichThuoc"].ToString();
                textbox03.Text = ds3.Tables[0].Rows[0]["VatLieu"].ToString();
                textbox04.Text = ds3.Tables[0].Rows[0]["CTDayVao"].ToString();
                textbox05.Text = ds3.Tables[0].Rows[0]["CTDayRa"].ToString();
