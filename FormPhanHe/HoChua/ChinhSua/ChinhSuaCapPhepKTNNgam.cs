...
{
    public partial class ChinhSuaCapPhepKTNNgam : Form
    {
        ...
        private void ChinhSuaCapPhepKTNNgam_Load(object sender, EventArgs e)
        {
            ...
            if (IDChinhSua != 0)
            {
                SqlDataAdapter adp3 = new SqlDataAdapter("[PRC_QUERY_TABLE_CapPhepKTNNgam_By_ID] " + IDChinhSua + "", QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
                DataSet ds3 = new DataSet();
                adp3.Fill(ds3);
                textbox01.Text = ds3.Tables[0].Rows[0]["DonViXinCP"].ToString();
                textbox04.Text = ds3.Tables[0].Rows[0]["DiaChiDV"].ToString();
                textbox03.Text = ds3.Tables[0].Rows[0]["ViTri"].ToString();
                textbox06.Text = ds3.Tables[0].Rows[0]["LuongNuocKT"].ToString();
                textbox07.Text = ds3.Tables[0].Rows[0]["TangChuaNuoc"].ToString();
                textbox09.Text = ds3.Tables[0].Rows[0]["ThoiHanKT"].ToString();
                textbox10.Text = ds3.Tables[0].Rows[0]["MDKTSD"].ToString();
                textbox11.Text = ds3.Tables[0].Rows[0]["GhiChu"].ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                        ...
                        conn.Open();
                        string sql1 = "[PRC_UPDATE_CapPhepKTNNgam] "
                           + " '" + objectid
                           + "', '" + dateCP
                           + "', N'" + textBox1.Text
                           + "', N'" + textbox01.Text
                        ...
                        MessageBox.Show("Chỉnh sửa Cấp phép khai thác nước ngầm thành công", "Thông báo");
                ...
                catch
                {
                    ...
                    MessageBox.Show("Chỉnh sửa Cấp phép khai thác nước ngầm thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
