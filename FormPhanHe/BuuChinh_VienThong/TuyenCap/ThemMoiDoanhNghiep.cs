...
{
    public partial class ThemMoiDoanhNghiep : Form
    {
        DataTable tb;
        DataTable tbcheck;
        ...
        public ThemMoiDoanhNghiep()
        {
            InitializeComponent();
        }

        private void ThemMoiDoanhNghiep_Load(object sender, EventArgs e)
        {
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn muốn thêm mới dữ liệu" + " không?", "Thêm dữ liệu", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                try
                {
                    ...
                    conn.Open();
                    string INSERT = "[PRC_INSERT_DOANHNGHIEP] N'" + txtTenDoanhNghiep.Text + "',N'" + txtTenVietTat.Text + "',N'" + txtMoTa.Text + "',N'" + txtGhiChu.Text + "'";
