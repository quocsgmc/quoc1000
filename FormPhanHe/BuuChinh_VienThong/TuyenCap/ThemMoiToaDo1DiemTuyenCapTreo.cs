...
{
    public partial class ThemMoiToaDo1DiemTuyenCapTreo : Form
    {
        public static int STT = 0;
        public static double X = 0;
        public static double Y = 0;
        public ThemMoiToaDo1DiemTuyenCapTreo()
        {
            InitializeComponent();
        ...
        {
            for (int i = 1; i < QuanLyToaDoTuyenCapTreo.numrow; i++)
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            this.Hide();
            QuanLyToaDoTuyenCapTreo.ThemDiem = 1;
        }
