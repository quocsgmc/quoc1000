...
{
    public partial class QuanLyToaDoTuyenCapTreo : Form
    {
        ...
        int IDTuyenCapTreo = QLHTDT.FormPhanHe.BuuChinh_VienThong.TuyenCap.QuanLyTuyenCapTreo.ID1;
        int IDCHUDAUTU;
        ...
        //string sql = "[PRC_ToaDoTuyenCapTreo_GET_BY_ID] " + IDTuyenCapTreo + "";
        public QuanLyToaDoTuyenCapTreo()
        {
            InitializeComponent();
        ...
        private void QuanLyToaDoTuyenCapTreo_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn muốn lưu các dữ liệu thay đổi không?", "Lưu dữ liệu", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                try
                {
                    string shape = "[PRC_UPDATE_SHAPE_TUYENCAPTREO] " + IDTuyenCapTreo + ", 'LINESTRING (";
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            ThemMoiToaDo1DiemTuyenCapTreo frm = new ThemMoiToaDo1DiemTuyenCapTreo();
            frm.ShowDialog();
            if (ThemDiem == 1)
            {
                DataRow barackRow = getRow(tb, ThemMoiToaDo1DiemTuyenCapTreo.X, ThemMoiToaDo1DiemTuyenCapTreo.Y);
                tb.Rows.InsertAt(barackRow, ThemMoiToaDo1DiemTuyenCapTreo.STT);
                ThemDiem = 0;
            }
            converttable();
            GridView1.RefreshData();
