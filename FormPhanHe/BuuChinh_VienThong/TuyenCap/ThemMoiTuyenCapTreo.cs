...
{
    public partial class ThemMoiTuyenCapTreo : Form
    {
        ...
        private void ThemMoiTuyenCapTreo_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            double KDo; double VDo; string TTrang;
            ...
            if (check != false)
            {
                try
                {
                    ftClassSDE = QLHTDT.FormChinh.KienTruc.FeatureWorkspace.OpenFeatureClass("TuyenCapTreo");
                    // tạo mới đối tượng
                    ...
                    conn.Open();
                    string sqlShape = "[PRC_UPDATE_SHAPE_TUYENCAPTREO] '" + objectid + "', 'LINESTRING(";
                    ...
                    MessageBox.Show("Thêm mới Tuyến cáp treo thành công", "Thông báo");
                    this.Hide(); Cursor = Cursors.Default;
                    BuuChinh_VienThong.TuyenCap.QuanLyTuyenCapTreo.LoadLaiForm = 1;
                }
                catch
                {
                    ...
                    MessageBox.Show("Thêm mới Tuyến cáp treo thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
