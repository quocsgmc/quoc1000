...
{
    public partial class ChinhSuaTuyenCapNgam : Form
    {
        ...
        int IDChinhSua = QLHTDT.FormPhanHe.BuuChinh_VienThong.TuyenCap.QuanLyTuyenCapNgam.ID1;
        public ChinhSuaTuyenCapNgam()
        {
            InitializeComponent();
            if (QLHTDT.FormChinh.KienTruc.FeatureWorkspace != null)
            { featureWorkspaceSDE = QLHTDT.FormChinh.KienTruc.FeatureWorkspace; }
        }
        private void ChinhSuaTuyenCapNgam_Load(object sender, EventArgs e)
        {
            ...
            if (IDChinhSua != 0)
            {
                SqlDataAdapter adp3 = new SqlDataAdapter("[PRC_QUERY_TuyenCapNgam_BY_ID] " + IDChinhSua + "", QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
