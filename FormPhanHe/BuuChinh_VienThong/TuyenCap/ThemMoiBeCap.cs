...
{
    public partial class ThemMoiBeCap : Form
    {
        ...
        private void ThemMoiBeCap_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    {
                        ftClassSDE = QLHTDT.FormChinh.KienTruc.FeatureWorkspace.OpenFeatureClass("BECAP");
                        // tạo mới đối tượng
                        ...
                        BuuChinh_VienThong.TuyenCap.QuanLyBeCap.LoadLaiForm = 1;
                        this.Hide(); Cursor = Cursors.Default;
                        MessageBox.Show("Thêm mới Bể cáp thành công", "Thông báo");
                    }
                    else
                    {
                        ftClassSDE = QLHTDT.FormChinh.KienTruc.FeatureWorkspace.OpenFeatureClass("BECAP");
                ...
                catch
                {
                    ...
                    MessageBox.Show("Thêm mới Bể cáp thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
