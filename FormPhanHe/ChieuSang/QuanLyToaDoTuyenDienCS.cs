...
{
    public partial class QuanLyToaDoTuyenDienCS : Form
    {
        ...
        private void QuanLyToaDoTuyenDienCS_Load(object sender, EventArgs e)
        {
        ...
        {
            string sql = "[PRC_ToaDoTuyenDienCS_GET_BY_ID] " + IDTuyenCapNgam + "";
            tb = new DataTable();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Bạn muốn lưu các dữ liệu thay đổi không?", "Lưu dữ liệu", MessageBoxButtons.YesNo) == DialogResult.Yes)
            {
                try
                {
                    string shape = "[PRC_UPDATE_SHAPE_TUYENDIENCS] " + IDTuyenCapNgam + ", 'LINESTRING (";
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            ThemMoiToaDo1DiemTuyenDienCS frm = new ThemMoiToaDo1DiemTuyenDienCS();
            frm.ShowDialog();
            if (frm.Visible == false)
            {
                DataRow barackRow = getRow(tb, ThemMoiToaDo1DiemTuyenDienCS.X, ThemMoiToaDo1DiemTuyenDienCS.Y);
                tb.Rows.InsertAt(barackRow, ThemMoiToaDo1DiemTuyenDienCS.STT);
            }
            converttable();
            GridView1.RefreshData();
        }
