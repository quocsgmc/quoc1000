...
{
    public partial class TuyenDienDCShapefile : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        private void TuyenDienDCShapefile_Load(object sender, EventArgs e)
        {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < featureClass.FeatureCount(null); i++)
            {
                ...
                int TT1 = ftClassSDE.FindField("TENTUYEN");
                ...
                int TT6 = ftClassSDE.FindField("LOAIDAY");
                ...
                int TT7 = ftClassSDE.FindField("GHICHU");
