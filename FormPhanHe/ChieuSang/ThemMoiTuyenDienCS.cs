...
{
    public partial class ThemMoiTuyenDienCS : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        private void ThemMoiTuyenDienCS_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    KienTruc.ThemMoiDoiTuong("Tuyến điện chiếu sáng kiệt hẻm", objectid);
                    KienTruc.dataAdapterNK.Update(KienTruc.TBNK);

                    MessageBox.Show("Thêm mới Tuyến điện chiếu sáng thành công", "Thông báo");
