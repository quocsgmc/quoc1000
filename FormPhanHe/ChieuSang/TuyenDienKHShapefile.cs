...
{
    public partial class TuyenDienKHShapefile : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        private void TuyenDienKHShapefile_Load(object sender, EventArgs e)
        {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Thêm mới Tuyến điện chiếu sáng kiệt hẻm thành công", "Thông báo");
