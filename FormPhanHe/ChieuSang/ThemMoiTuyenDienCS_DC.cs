...
{
    public partial class ThemMoiTuyenDienCS_DC : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        int IDChinhSua = QLHTDT.FormPhanHe.ChieuSang.QuanLyTuyenDienChieuSang.ID1;
        public ThemMoiTuyenDienCS_DC()
        {
            InitializeComponent();
        ...
        private void ThemMoiTuyenDienCS_DC_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    KienTruc.ThemMoiDoiTuong("Tuyến điện chiếu sáng đường chính", objectid);
                    KienTruc.dataAdapterNK.Update(KienTruc.TBNK);

                    MessageBox.Show("Thêm mới Tuyến điện chiếu sáng đường chính thành công", "Thông báo");
                ...
                catch
                {
                    ...
                    MessageBox.Show("Thêm mới Tuyến điện chiếu sáng thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
