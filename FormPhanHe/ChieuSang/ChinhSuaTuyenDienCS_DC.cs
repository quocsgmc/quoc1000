...
{
    public partial class ChinhSuaTuyenDienCS_DC : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        int IDChinhSua;
        string IDPhuong;
        public ChinhSuaTuyenDienCS_DC(int OBJECTID)
        {
            InitializeComponent();
        ...
        private void ChinhSuaTuyenDienCS_DC_Load(object sender, EventArgs e)
        {
            ftClassSDE = KienTruc.FeatureWorkspace.OpenFeatureClass("TUYENDIENCSDC");
            ...
            if (IDChinhSua != 0)
            {
                SqlDataAdapter adp3 = new SqlDataAdapter("[PRC_QUERYTuyenDienCSDC_BY_ID] " + IDChinhSua + "", QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    string sql1 = "[PRC_UPDATE_TUYENDIENCHIEUSANGDC_BY_ID] "
                        + " '" + objectid
                        + "', N'" + txtTenTuyen.Text
                        + "', N'" + txtDiaChi.Text
                        + "', '" + ChieuDai
                    ...
                    KienTruc.ChinhSuathuoctinhToolQuanLy("Tuyến điện chiếu sáng đường chính", objectid);
                    KienTruc.dataAdapterNK.Update(KienTruc.TBNK);

                    this.Hide(); Cursor = Cursors.Default;
                    ChieuSang.QuanLyTuyenDienChieuSang_DC.LoadLaiForm = 1;
                ...
                catch
                {
                    ...
                    MessageBox.Show("Chỉnh sửa Tuyến điện chiếu sáng thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
