...
{
    public partial class ThemMoiQuanLyQH : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        private void ThemMoiQuanLyQH_Load(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    SqlConnection conn = new SqlConnection(QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
                        ...
                        MessageBox.Show("Thêm mới quy hoạch khoáng sản thành công", "Thông báo");
                ...
                catch
                {
                    ...
                    MessageBox.Show("Thêm mới quy hoạch khoáng sản thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
