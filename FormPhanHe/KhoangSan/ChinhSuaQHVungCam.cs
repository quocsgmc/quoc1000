...
{
    public partial class ChinhSuaQHVungCam : Form
    {
        string typeSDE = "";
        string typeSHP = "";
        ...
        int IDChinhSua = QLHTDT.FormPhanHe.KhoangSan.QHVungCam2.QHVungCam2.ID1;
        string dateTGT = "null";
        string IDPhuong = "null";
        string IDQuan = "null";
        public ChinhSuaQHVungCam()
        {
            InitializeComponent();
        ...
        private void ChinhSuaQHVungCam_Load(object sender, EventArgs e)
        {
            ...
            if (IDChinhSua != 0)
            {
                SqlDataAdapter adp3 = new SqlDataAdapter("[PRC_QUERY_QuyHoachVungCam_BY_ID] " + IDChinhSua + "", QLHTDT.FormPhu.QTHT.MaHoa.Rot13(QLHTDT.Properties.Settings.Default.strConnectionDAQH));
                DataSet ds3 = new DataSet();
                adp3.Fill(ds3);
                //txtIDTuyen.Text = ds3.Tables[0].Rows[0]["IDTuyen"].ToString();
                textBox1.Text = ds3.Tables[0].Rows[0]["DoiTuong"].ToString();
                textBox2.Text = ds3.Tables[0].Rows[0]["DienTich"].ToString();
                textBox3.Text = ds3.Tables[0].Rows[0]["TT"].ToString();
                textBox4.Text = ds3.Tables[0].Rows[0]["KhuVucQH"].ToString();
                ...
                IDQuan = ds3.Tables[0].Rows[0]["MaHuyen"].ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (check != false)
            {
                try
                {
                    ...
                    KienTruc.ChinhSuathuoctinhToolQuanLy("Quy hoạch vùng cấm", objectid);
                    KienTruc.dataAdapterNK.Update(KienTruc.TBNK);

                    MessageBox.Show("Chỉnh sửa quy hoạch vùng cấm thành công", "Thông báo");
                ...
                catch
                {
                    ...
                    MessageBox.Show("Chỉnh sửa quy hoạch vùng cấm thất bại. Vui lòng kiểm tra dữ liệu", "Thông báo");
        ...
        private void comboQuan_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (AddQuan == 1)
            {
                ...
                IDQuan = comboQuan.SelectedValue.ToString();
